...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val fab = v?.findViewById<FloatingActionButton>(R.id.fabLogout)
        fab?.let {
        ...
        fabHelp.setOnClickListener {
            val sendIntent = Intent(Intent.ACTION_VIEW).apply {
                this.data = Uri.parse("https://www.pedulilindungi.id/")
            }
            val shareIntent = Intent.createChooser(sendIntent, "Choose your browser")
